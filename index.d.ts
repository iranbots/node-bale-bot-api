...
declare class TelegramBot extends EventEmitter {
    ...
    editMessage(chatId: number | string, messageId: number | string, text: string, options?: TelegramBot.SendMessageOptions): Promise<TelegramBot.Message>;
...
//    editMessageLiveLocation(latitude: number, longitude: number, options?: TelegramBot.EditMessageLiveLocationOptions): Promise<TelegramBot.Message | boolean>;
    ...
    deleteMessage(chatId: number | string, messageId: string | number, options?: any): Promise<boolean>;
